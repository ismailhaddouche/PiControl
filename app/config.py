"""
Configuration management for PiControl.

All settings loaded from environment variables for 12-factor app compliance.
"""
...
class Config:
    """Central configuration class with environment variable parsing."""
    ...
    def get_secret_key(cls) -> str:
        """Return SECRET_KEY with runtime validation."""
    ...
    SESSION_MAX_AGE: int = int(os.environ.get("SESSION_LIFETIME", "3600"))
    ...
    RFID_MODE: str = os.environ.get("PICONTROL_RFID_MODE", "evdev")
    ...
    def ensure_directories(cls) -> None:
        ...
        for directory in directories:
            try:
                ...
                pass  # Silently continue in restricted environments

    @classmethod
    def validate(cls) -> list[str]:
        """Run validation checks on current configuration.
